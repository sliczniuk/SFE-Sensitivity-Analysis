...
\begin{document}
	...
	{\footnotesize
		\begin{equation} 
			...
			As explained in Chapters \ref{CH:Governing_equations_chapter}, {\color{blue}this low velocity region, pressure is}, nearly constant due to the small pressure wave propagation that occurs at the speed of sound. Under such conditions, the term $\partial P/\partial t$ can be approximated by a difference equation, {\color{blue}describing} the pressure change in the whole system. The pressure $P$ in the system is considered a state variable, while the pressure in the new time-step $P_{in}$ is considered a control variable.
